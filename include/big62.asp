<TABLE width="1002" border=0 align="center" cellPadding=0 cellSpacing=0>
  <TBODY>
    <TR>
      <TD><img src="images/xxl_13.png" width="1002" height="55" border="0" usemap="#Mapf" /></TD>
    </TR>
  </TBODY>
</TABLE>
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
	...
	rs.open "select Top "&tejia&" * from products where anclassid=62 and zhuangtai=0 order by bookid desc ",conn,1,1
...
<map name="Mapf" id="Mapf">
  <area shape="rect" coords="906,18,993,43" href="class.asp?lx=big&anid=62" />
</map>